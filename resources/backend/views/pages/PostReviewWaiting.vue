                ...
                <div class="panel panel-bordered">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            Danh sách bài viết đợi phê duyệt
                        </h3>
                    </div>
...
export default {
  ...
  methods: {
    async getPostReviews({ page, filter, sort }) {
      try {
        const response = await PostReviewService.getPostReviewRequestApprove({
          page: page,
          text: filter,
    ...
    approve(id) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          PostReviewService.approve(id , 1).then(response => {
            if (response) {
              Swal.fire({
                type: "success",
                title: "Thành công",
              ...
              Swal("Xin lỗi", "Xóa thất bại", "error");
            }
          });
        }
      });
