                    ...
                    <div class="col-sm-6 col-md-4 ">
                        ...
                        <div class="wrap-gallery-footer flex-w">
                            <a class="item-gallery-footer wrap-pic-w" href="#">
                                <img src="/images/food.jpeg" alt="GALLERY" />
                            </a>

                            <a class="item-gallery-footer wrap-pic-w" href="#">
                                <img src="/images/food2.jpg" alt="GALLERY" />
                            </a>
                ...
                <div class="container">
                    <div class="flex-sb-m flex-w ">
                        <div class="p-t-5 p-b-5">
                            ...
                            <a href="#" class="fs-15 c-white">
                                <i
                                    class="fab fa-facebook m-l-18"
                                    aria-hidden="true"
                                ></i>
                            </a>
                            <a href="#" class="fs-15 c-white">
                                <i
                                    class="fab fa-twitter m-l-18"
                                    aria-hidden="true"
                                ></i>
                            </a>
                        </div>
                        ...
                        <div class="txt17 p-r-20 p-t-5 p-b-5">
                            Copyright &copy; 2019 All rights reserved | This
